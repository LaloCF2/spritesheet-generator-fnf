...
## 🚀 En Vivo
👉 **[¡Prueba usando la web!]
[https://lalocf2.github.io/spritesheet-generator-fnf/]**
...
* **Mapeo:** Detecta islas de píxeles automáticamente mediante el canal Alfa.
* **Algoritmo de Fusión:** Evita la creación de "mini-contornos" basura dentro de cajas grandes fusionando automáticamente bloques superpuestos o internos.
...
### 🛠️ 3. Optimizador (Desduplicación de Texturas)
